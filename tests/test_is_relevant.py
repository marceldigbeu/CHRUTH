...
def test_still_excludes_metier():
    # Mot-cle secondaire (desinfection) + terme d'exclusion SOUPLE (repas) sans mot-cle
    # nettoyage FORT -> exclusion metier. ("restauration collective" est passee en dure.)
    keep, reason = is_relevant(_rec("Desinfection et livraison de repas"), {}, False, False)
    assert keep is False
    assert reason == "exclusion metier"
